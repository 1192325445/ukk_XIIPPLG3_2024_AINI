			...
			<div class="card">
				...
				<div class="card-footer text-center">
					...
					if (mysqli_num_rows($ceksuka) == 1) {?>
						<a href="../config/proses_like.php?fotoid=<?php echo $data['fotoid'] ?>" type="submit" name="batalsuka"><i class="far fa-heart"></i></a>
					<?php } else { ?>
					...
					?>
					<a href=""><i class="far fa-comment"></i></a> Komentar
				</div>
			</div>
		</div>
		...
		<div class="col-md-2 mt-2">
			<div class="card">
				...
				<div class="card-footer text-center">
					...
					echo mysqli_num_rows($like). ' Suka';
					?>
					<a href=""><i class="far fa-comment"></i></a>3 Komentar
				</div>
			</div>
		</div>
		<?php
...
<footer class="d-flex justify-content-center border-top mt-3 bg-ligth fixed-bottom">
	<p>&copy; UKK RPL 2024 | Citra Ayu</p>
</footer>
